...
export default function FooterComp() {
  ...
  return (
    <Footer
      ...
      } rounded-0 shadow-none w-[100%]`}
    >
      <div className='m-auto max-w-[1600px] lg:max-w-[2300px] md:flex md:items-center md:!justify-between md:gap-45'>
        <FooterCopyright
          className={`${
          ...
          year={2025}
        />
        <FooterLinkGroup className='flex justify-center align-middle gap-5 pt-2 md:!pt-0 mb-0 '>
          <FooterLink
            children='GitHub'
